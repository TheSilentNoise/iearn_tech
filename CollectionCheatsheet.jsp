...
<div class="col-sm-12">
	...
	<h2 class="text-center blog-heading ">Collection Framework Cheat
		Sheet</h2>
	<br />
	...
	<img src="img/collection-flow.jpg" class="img-responsive"> <br />
	<br />

	<h4>Collection Methods</h4>
	<img src="img/collection-methods.jpg" class="img-responsive"> <br />
	<br />
